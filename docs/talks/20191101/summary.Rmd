...
On 1st November 2019, the BBS organized a seminar on _Predictive modelling, machine learning, and causality_ with several eminent speakers. The full program including abstracts of all talks is available [here](http://bbs.ceb-institute.org/?p=1317).
...
["Clinical prediction models in the age of artificial intelligence and big data"](slides/1_Steyerberg.pdf). 
...
[Willi Sauerbrei](https://www.imbi.uni-freiburg.de/persons-de/wfs-de/person_view_de) gave a thorough [talk on guidelines](slides/2_Sauerbrei.pdf). 
...
[Torsten Hothorn](http://user.math.uzh.ch/hothorn/) gave a presentation on ["Score-based Transformation Learning"](slides/3_Hothorn.pdf). 
