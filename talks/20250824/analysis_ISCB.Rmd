...
# make numbers meet
reg4 <- rbind(reg4, data.frame("inst2" = rep(NA, 9), "country2" = c("Iran", "Ireland", "Israel", "Hungary", "Philippines", "Vietnam", "Slovakia", "Portugal", "Liechtenstein")))
reg4[reg4$country == "España", ] <- "Spain"
...
t2[names(t2) == "Switzerland"] <- 179
t2[names(t2) == "United Kingdom"] <- 133
t2[names(t2) == "Germany"] <- 101
t2[names(t2) == "Netherlands"] <- 49
t2[names(t2) == "other"] <- 34
