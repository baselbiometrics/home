...
This R markdown file provides the code accompanying the first theory block in the BBS course [Advanced group-sequential and adaptive confirmatory clinical trial designs, with R practicals using rpact](https://baselbiometrics.github.io/home/docs/upcoming/20220913/agenda.pdf).
...
For code and recommendationas how to handle bias in group-sequential designs we refer to [Question 3.8](go.roche.com/adaptr) in the **adaptR** Q&A section.
